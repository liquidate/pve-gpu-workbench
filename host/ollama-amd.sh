...
# Setup logging
setup_logging "ollama-lxc-install" "Ollama AMD LXC Installation"
...
error_handler() {
    ...
    echo -ne "\r\033[K"
    echo ""
    echo -e "${RED}✗ Failed: ollama-amd${NC}"
    echo ""
...
echo -e "   ${GREEN}ssh root@$IP_ADDRESS${NC}"
echo -e "   ${GREEN}radeontop${NC}  ${DIM}(or rocm-smi for quick status)${NC}"
echo ""
